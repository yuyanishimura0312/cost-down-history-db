...
テーブル別レコード数は以下の通りである。スキーマ定義どおりに methods 346 件 / evidence 190 件 / genealogy 107 件 / critiques 47 件 / domains 15 件が格納されている。
...
| WARN | evidence.value magnitude > 1e7: [('CDH-EVD-0029', 16000000000.0, 'USD', 'cost_savings_usd'), ('CDH-EVD-0030', 12000000000.0, 'USD', 'cost_savings_usd'), ('CDH-EVD-0040', 10000000000.0, 'USD', 'cost_savings_usd'), ('CDH-EVD-0292', 214000000.0, 'proteins', 'structure_db_growth'), ('CDH-EVD-0294', 40000000.0, 'USD/yr', 'cost_savings_usd_annual'), ('CDH-EVD-0308-001', 79500000.0, 'USD', 'annual_cost_savings_usd'), ('CDH-EVD-0319-014', 250000000000.0, 'USD', 'cumulative_host_income')] |
| WARN | % unit but value > 100 (review whether intended): [('CDH-EVD-0300', 'productivity_increase_pct', 126.0, '%'), ('CDH-EVD-0601', 'productivity_increase_pct', 200.0, '%'), ('CDH-EVD-0663', 'productivity_increase_pct', 126.0, '%')] |
...
| WARN | year_transition era misalignment (14): [('CDH-REL-0083', 'year_transition before parent.era_start', 2013, 2018), ('CDH-REL-0085', 'year_transition >> child.era_start (+5y tolerance)', 1980, 1972), ('CDH-REL-0087', 'year_transition before parent.era_start', 2008, 2011), ('CDH-REL-0088', 'year_transition before parent.era_start', 2011, 2015), ('CDH-REL-0088', 'year_transition >> child.era_start (+5y tolerance)', 2011, 1973)] |
...
| https://www.caterpillar.com/en/company/sustainability/remanufacturing.html | 403 | HTTPError 403 |
...
| https://www.adb.org/sites/default/files/publication/964626/adb-brief-299-india-u | 404 | HTTPError 404 |
| https://www.ajmc.com/view/association-of-electronic-health-records-with-cost-sav | 404 | HTTPError 404 |
| https://www.cnbc.com/2024/05/10/recursion-pharmaceuticals-ceo-says-ai-speeds-up- | 404 | HTTPError 404 |
...
| https://www.gsma.com/solutions-and-impact/connectivity-for-good/mobile-for-devel | 404 | HTTPError 404 |
...
| https://news.rice.edu/news/2025/openstax-surpasses-3b-student-savings-grows-beyo | 406 | HTTPError 406 |
...
| WARN | potential near-duplicate method names (ratio ≥ 0.9): 1 pair(s) |
...
### 7.2. 類似名 method ペア（ratio ≥ 0.90）

| method_id (A) | method_id (B) | name_ja (A) | name_ja (B) | name_en (A) | name_en (B) | ratio |
|---|---|---|---|---|---|---|
| CDH-MET-0307 | CDH-MET-0555 | Cradle-to-Cradle設計（C2C） | Cradle-to-Cradle設計 | Cradle-to-Cradle Design | Cradle-to-Cradle Design | 1.0 |
...
3. 類似名ペアは（a）同義表記揺れの統合、または（b）意図的な区別を明示するための name_en 補強を検討する。
